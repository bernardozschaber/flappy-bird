...
const char * ACHIEVEMENTS_LOCKED[16] = {
    "../assets/UI/achievements/achievements-01-locked.png",
    "../assets/UI/achievements/achievements-02-locked.png",
    "../assets/UI/achievements/achievements-03-locked.png",
    "../assets/UI/achievements/achievements-04-locked.png",
    "../assets/UI/achievements/achievements-05-locked.png",
    "../assets/UI/achievements/achievements-06-locked.png",
    "../assets/UI/achievements/achievements-07-locked.png",
    "../assets/UI/achievements/achievements-08-locked.png",
    "../assets/UI/achievements/achievements-09-locked.png",
    "../assets/UI/achievements/achievements-10-locked.png",
    "../assets/UI/achievements/achievements-11-locked.png",
    "../assets/UI/achievements/achievements-12-locked.png",
    "../assets/UI/achievements/achievements-13-locked.png",
    "../assets/UI/achievements/achievements-14-locked.png",
    "../assets/UI/achievements/achievements-15-locked.png",
...
Achievements_Screen::Achievements_Screen() {
    ...
    achievements_locked[0] = al_load_bitmap(ACHIEVEMENTS_LOCKED[0]);
    achievements_locked[1] = al_load_bitmap(ACHIEVEMENTS_LOCKED[1]);
    achievements_locked[2] = al_load_bitmap(ACHIEVEMENTS_LOCKED[2]);
    achievements_locked[3] = al_load_bitmap(ACHIEVEMENTS_LOCKED[3]);
    achievements_locked[4] = al_load_bitmap(ACHIEVEMENTS_LOCKED[4]);
    achievements_locked[5] = al_load_bitmap(ACHIEVEMENTS_LOCKED[5]);
    achievements_locked[6] = al_load_bitmap(ACHIEVEMENTS_LOCKED[6]);
    achievements_locked[7] = al_load_bitmap(ACHIEVEMENTS_LOCKED[7]);
    achievements_locked[8] = al_load_bitmap(ACHIEVEMENTS_LOCKED[8]);
    achievements_locked[9] = al_load_bitmap(ACHIEVEMENTS_LOCKED[9]);
    achievements_locked[10] = al_load_bitmap(ACHIEVEMENTS_LOCKED[10]);
    achievements_locked[11] = al_load_bitmap(ACHIEVEMENTS_LOCKED[11]);
    achievements_locked[12] = al_load_bitmap(ACHIEVEMENTS_LOCKED[12]);
    achievements_locked[13] = al_load_bitmap(ACHIEVEMENTS_LOCKED[13]);
    achievements_locked[14] = al_load_bitmap(ACHIEVEMENTS_LOCKED[14]);
    achievements_locked[15] = al_load_bitmap(ACHIEVEMENTS_LOCKED[15]);
...
Achievements_Screen::~Achievements_Screen() {
    ...
    al_destroy_bitmap(achievements_locked[0]);
    al_destroy_bitmap(achievements_locked[1]);
    al_destroy_bitmap(achievements_locked[2]);
    al_destroy_bitmap(achievements_locked[3]);
    al_destroy_bitmap(achievements_locked[4]);
    al_destroy_bitmap(achievements_locked[5]);
    al_destroy_bitmap(achievements_locked[6]);
    al_destroy_bitmap(achievements_locked[7]);
    al_destroy_bitmap(achievements_locked[8]);
    al_destroy_bitmap(achievements_locked[9]);
    al_destroy_bitmap(achievements_locked[10]);
    al_destroy_bitmap(achievements_locked[11]);
    al_destroy_bitmap(achievements_locked[12]);
    al_destroy_bitmap(achievements_locked[13]);
    al_destroy_bitmap(achievements_locked[14]);
